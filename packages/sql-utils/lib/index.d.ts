...
export declare class Builder {
    ...
    compileTransform(type: Type | Eval.Expr | undefined, method: 'encode' | 'decode' | 'load' | 'dump'): (value: string) => any;
    compileLoad(type: Model | Type | Eval.Expr | undefined, root?: boolean): (value: any) => any;
    /**
