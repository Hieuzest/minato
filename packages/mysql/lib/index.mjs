...
import { Driver as Driver2, executeUpdate, Field as Field2, RuntimeError, z } from "minato";
...
var MySQLDriver = class extends Driver2 {
  static name = "mysql";
  pool;
...
INSERT INTO mtt VALUES(json_extract(j, concat('$[', i, ']'))); SET i=i+1; END WHILE; SELECT max(value) INTO r FROM mtt; RETURN r; END`);
  ...
  async dropAll() {
    ...
    await this.query([
      ...
      ...data.map(({ TABLE_NAME }) => `DROP TABLE ${escapeId2(TABLE_NAME)}`),
